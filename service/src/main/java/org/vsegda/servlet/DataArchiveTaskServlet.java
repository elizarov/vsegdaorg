...
public class DataArchiveTaskServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        DataStream stream = DataStreamStorage.INSTANCE.loadDataStreamById(streamId);
        ...
        switch (stream.getMode()) {
            ...
            case RECENT:
                ...
                DataArchiveStorage.INSTANCE.removeAllByStreamId(stream.getStreamId());
        }
        ...
        switch (stream.getMode()) {
            case LAST:
                ...
                DataItemService.INSTANCE.removeDataItems(stream, items);
                break;
            case RECENT:
            ...
            case ARCHIVE:
                ...
                DataArchiveStorage.INSTANCE.storeDataArchive(archive);
                DataItemService.INSTANCE.removeDataItems(stream, items);
                break;
        }
