...
class DataArchiveTest {
    ...
    fun testCodec() {
        ...
        put.add(DataItem(sid, 12.5, parseTime("20120101T150000.000", 0)))
        put.add(DataItem(sid, 12.5, parseTime("20120101T150500.000", 0)))
        put.add(DataItem(sid, 12.5, parseTime("20120101T151000.000", 0)))
        put.add(DataItem(sid, 12.5, parseTime("20120101T152000.000", 0)))
        put.add(DataItem(sid, 12.6, parseTime("20120101T152500.000", 0)))
        put.add(DataItem(sid, 12.7, parseTime("20120101T153000.000", 0)))
        put.add(DataItem(sid, 12.9, parseTime("20120101T153500.000", 0)))
        put.add(DataItem(sid, 13.0, parseTime("20120101T154000.000", 0)))
        put.add(DataItem(sid, 13.5, parseTime("20120101T154500.000", 0)))
        put.add(DataItem(sid, 13.4, parseTime("20120101T155000.000", 0)))
        put.add(DataItem(sid, 13.2, parseTime("20120101T155500.000", 0)))
        put.add(DataItem(sid, 12.2, parseTime("20120101T160000.000", 0)))
        put.add(DataItem(sid, 12.0, parseTime("20120101T160500.000", 0)))
        // encode
